...
public:
    ...
    */
    std::vector<std::pair<char, battleships::coordinate>> useShip(battleships::coordinate xyShip,
 ...
 private:
    ...
    *
    * @param xy coordinate to verify,
    * @param s  ship to control
