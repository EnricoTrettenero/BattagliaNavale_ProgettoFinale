...
int main()
{
    unique_ptr<player> ai1 = make_unique<ai>("ai1");
    unique_ptr<player> ai2 = make_unique<ai>("ai2");

    game g = game(std::move(ai1), std::move(ai2), "output.txt");
...
//    cout << d.isDamaged(battleships::coordinate(8, 'F')) << endl;
//    cout << d << endl;
    return 0;
}
